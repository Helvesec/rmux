...
**エージェント時代のための汎用 Rust ターミナルマルチプレクサ。detach 可能、スクリプト可能、検査可能で、tmux 互換 CLI、daemon-backed SDK、ネイティブ [Ratatui](https://ratatui.rs) 統合を備えています。**
...
<table>
  <tr>
    ...
    <td align="center" width="20%"><a href="https://rmux.io/#demo-broadcast"><img src="https://rmux.io/demos/demo-broadcast.png" width="150" alt="Agent Broadcast Arena デモのプレビュー"></a><br><sub><a href="https://github.com/Helvesec/rmux-demos/tree/main/demo-broadcast"><strong>Agent Broadcast Arena</strong></a></sub><br><sub>≃ 2,171 lines</sub></td>
    <td align="center" width="20%"><a href="https://rmux.io/#demo-zellij"><img src="https://rmux.io/demos/demo-zellij.png" width="150" alt="Mini-Zellij デモのプレビュー"></a><br><sub><a href="https://github.com/Helvesec/rmux-demos/tree/main/demo-zellij"><strong>Mini-Zellij</strong></a></sub><br><sub>≃ 944 lines</sub></td>
    <td align="center" width="20%"><a href="https://rmux.io/#demo-mirroring"><img src="https://rmux.io/demos/demo-mirroring.png" width="150" alt="ターミナルとブラウザのミラーリングデモのプレビュー"></a><br><sub><a href="https://github.com/Helvesec/rmux-demos/tree/main/demo-mirroring"><strong>ターミナル &lt;&gt; ブラウザミラーリング</strong></a></sub><br><sub>≃ 649 lines</sub></td>
    <td align="center" width="20%"><a href="https://rmux.io/#demo-playwright"><img src="https://rmux.io/demos/demo-playwright.png" width="150" alt="Playwright テストデモのプレビュー"></a><br><sub><a href="https://github.com/Helvesec/rmux-demos/tree/main/demo-playwright"><strong>Playwright テスト</strong></a></sub><br><sub>≃ 1,495 lines</sub></td>
  </tr>
</table>
...
3つの public surface — `rmux` CLI、`rmux-sdk` Rust crate、`ratatui-rmux` widget — は、daemon と通信するための単一のローカル protocol を共有します。1つの surface でできることは、他の surface でもできます。

## Workspace

| Crate | 役割 | 公開 |
| :--- | :--- | :--- |
| `rmux-types` | platform-neutral な共有低レベル値型 | public |
| `rmux-proto` | Detached IPC DTOs、framing、wire-safe errors | public |
| `rmux-os` | 小さな OS boundary helpers | public |
| `rmux-ipc` | ローカル IPC endpoints と transports | public |
...
この workspace は、locked dependencies を使って source から検証できるように設計されています：
...
Release artifact checks は次の scripts で実行されます：
...
上位 crates では `#![forbid(unsafe_code)]` を使用しています。OS と terminal boundary code は低レイヤー runtime crates に隔離されています。
