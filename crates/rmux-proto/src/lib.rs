...
pub use capabilities::{
    ...
    CAPABILITY_SDK_SESSION_LEASE, CAPABILITY_SDK_SESSION_LEASE_BY_ID, CAPABILITY_SDK_WAITS,
    CAPABILITY_SDK_WAITS_ARMED, CAPABILITY_TARGET_CLIENT_COMMANDS, CAPABILITY_WEB_SHARE,
