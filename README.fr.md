...
J'ai donc reconstruit cette idee from scratch en Rust : un multiplexeur ultra-rapide compatible tmux, avec SDK type, sessions persistantes, snapshots structures et transports locaux natifs sur Linux, macOS et Windows, y compris les Windows Named Pipes.
